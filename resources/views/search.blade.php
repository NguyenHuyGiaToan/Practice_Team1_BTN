<x-laptop-layout>
    ...
    <div class="container">
        <div class="filter-section">
            ...
            @if(request()->anyFilled(['sort_gia']))
                <a href="{{ request()->fullUrlWithQuery(['sort_gia' => null]) }}" class="filter-btn" style="color: red; border-color: red;">X Xóa lọc</a>
            @endif
        </div>
                ...
                <div class="card">
                    <div class="card-img">
                        <a href="{{ route('sanpham.show', $sp->id) }}">
                            <img src="{{ asset('storage/image/' . $sp->hinh_anh) }}" alt="{{ $sp->tieu_de }}">
                        </a>
                    </div>
